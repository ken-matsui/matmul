...
# Executable files
EXECS = naive_run naive_bench blis_run blis_bench blis_autotune blis_old_bench gemm_run morello_run morello_bench # gemm_autotune
...
clean:
	rm -f *.o $(EXECS) libnaive.a Naive.h libblis.a $(BLIS_SRCS) Blis.h blis_autotune.c libgemm.a $(GEMM_SRCS) Gemm.h
