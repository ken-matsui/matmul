...
#](base_gflops: Float64, str: String) raises:
    ...
    let py = Python.import_module("builtins")
    _ = py.print(
        py.str("{:<15} {}s {:09}ns").format(str, secs, ns)
    )
...
fn main() raises:
    ...
    benchmark[matmul_tiled]("Tiled:")
    benchmark[matmul_unroll]("Unrolled:")
    benchmark[accumulate_registers]("Accumulated:")
