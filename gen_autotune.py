...
# name: Blis or Gemm
def generate_code(until, name):
    until = int(until) + 1

    code = "/* Autogenerated file. Do not edit manually. */\n"
    code += headers.format(name=name)
    for mc in range(0, until):
        for nc in range(0, until):
            for kc in range(0, until):
...
if __name__ == "__main__":
    until, name = sys.argv[1:3]
    print(generate_code(until, name))
